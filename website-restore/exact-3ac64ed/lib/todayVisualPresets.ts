...
export const TODAY_BROADCAST_PRESETS = [
  {
    ...
    labelRu: 'Впусти утренний свет',
    labelEn: 'Let the morning light in',
  },
  {
    id: 'roadtrip-dog',
    imageSrc: '/assets/today-broadcasts/v1/set-01-02-roadtrip-dog.webp',
    labelRu: 'Отправься в короткую поездку',
    labelEn: 'Take a short trip',
  },
  {
    id: 'lakeside-cyclists',
    imageSrc: '/assets/today-broadcasts/v1/set-01-03-lakeside-cyclists.webp',
    labelRu: 'Прокатись за город',
    labelEn: 'Take a ride out of town',
  },
  {
    id: 'cafe-morning',
    imageSrc: '/assets/today-broadcasts/v1/set-02-01-cafe-morning.webp',
    labelRu: 'Выпей кофе без спешки',
    labelEn: 'Have your coffee without rushing',
  },
  {
    id: 'city-flowers',
    imageSrc: '/assets/today-broadcasts/v1/set-02-02-city-flowers.webp',
    labelRu: 'Купи цветы без повода',
    labelEn: 'Buy flowers for no reason',
  },
  {
    id: 'sunlit-cat',
    imageSrc: '/assets/today-broadcasts/v1/set-02-03-sunlit-cat.webp',
    labelRu: 'Оставь время только для себя',
    labelEn: 'Keep some time just for yourself',
  },
  {
    id: 'coastal-picnic',
    imageSrc: '/assets/today-broadcasts/v1/set-03-01-coastal-picnic.webp',
    labelRu: 'Устрой пикник у воды',
    labelEn: 'Have a picnic by the water',
  },
  {
    id: 'rainy-smile',
    imageSrc: '/assets/today-broadcasts/v1/set-03-02-rainy-smile.webp',
    labelRu: 'Возьми зонт и выйди погулять',
    labelEn: 'Take an umbrella and go for a walk',
  },
  {
    id: 'laundromat-friends',
    imageSrc: '/assets/today-broadcasts/v1/set-03-03-laundromat-friends.webp',
    labelRu: 'Поболтай с теми, кто рядом',
    labelEn: 'Chat with the people around you',
  },
  {
    id: 'pottery-hands',
    imageSrc: '/assets/today-broadcasts/v1/set-04-01-pottery-hands.webp',
    labelRu: 'Займись чем-нибудь руками',
    labelEn: 'Make something with your hands',
  },
  {
    id: 'market-citrus',
    imageSrc: '/assets/today-broadcasts/v1/set-04-02-market-citrus.webp',
    labelRu: 'Выбери свежие фрукты',
    labelEn: 'Pick out some fresh fruit',
  },
  {
    id: 'mural-skater',
    imageSrc: '/assets/today-broadcasts/v1/set-04-03-mural-skater.webp',
    labelRu: 'Добавь в день больше движения',
    labelEn: 'Add more movement to your day',
  },
  {
    id: 'garden-reading',
    imageSrc: '/assets/today-broadcasts/v1/set-05-01-garden-reading.webp',
    labelRu: 'Почитай на свежем воздухе',
    labelEn: 'Read outdoors for a while',
  },
  {
    id: 'lake-paddleboard',
    imageSrc: '/assets/today-broadcasts/v1/set-05-02-lake-paddleboard.webp',
    labelRu: 'Отдохни на берегу',
    labelEn: 'Take a break by the water',
  },
  {
    id: 'cooking-together',
    imageSrc: '/assets/today-broadcasts/v1/set-05-03-cooking-together.webp',
    labelRu: 'Приготовь ужин с близкими',
    labelEn: 'Cook dinner with people you love',
  },
  {
    id: 'coastal-convertible',
    imageSrc: '/assets/today-broadcasts/v1/set-06-01-coastal-convertible.webp',
    labelRu: 'Съезди туда, где просторнее',
    labelEn: 'Go somewhere with more open space',
  },
  {
    id: 'kitchen-dance',
    imageSrc: '/assets/today-broadcasts/v1/set-06-02-kitchen-dance.webp',
    labelRu: 'Включи музыку и потанцуй',
    labelEn: 'Put on some music and dance',
  },
  {
    id: 'sunflower-field',
    imageSrc: '/assets/today-broadcasts/v1/set-06-03-sunflower-field.webp',
    labelRu: 'Проведи час на природе',
    labelEn: 'Spend an hour outdoors',
  },
  {
    id: 'evening-cafe-walk',
    imageSrc: '/assets/today-broadcasts/v1/set-07-01-evening-cafe-walk.webp',
    labelRu: 'Предложи кому-нибудь прогуляться',
    labelEn: 'Ask someone to join you for a walk',
  },
  {
    id: 'rooftop-dinner',
    imageSrc: '/assets/today-broadcasts/v1/set-07-02-rooftop-dinner.webp',
    labelRu: 'Собери друзей за столом',
    labelEn: 'Bring friends together for dinner',
  },
  {
    id: 'rainy-train-window',
    imageSrc: '/assets/today-broadcasts/v1/set-07-03-rainy-train-window.webp',
    labelRu: 'Напиши тому, по кому скучаешь',
    labelEn: 'Message someone you miss',
  },
