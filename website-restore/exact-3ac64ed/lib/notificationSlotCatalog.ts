...
export const NOTIFICATION_SLOT_CONFIG: Record<NotificationSlot, NotificationSlotConfig> = {
  ...
  daily_lumi: {
    ...
    defaultButtonText: 'Открыть NEBO',
    notesRu: 'Вечерний возврат в приложение. Ведёт на главный экран NEBO.',
    notesEn: 'Evening re-engagement. Deep-links into the NEBO home screen.',
  },
  upsell: {
    slot: 'upsell',
