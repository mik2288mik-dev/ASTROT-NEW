    ...
    return (
        <div className="p-4 pb-32 space-y-6">
            ...
            <button 
                ...
                className="w-full bg-astro-card rounded-2xl p-6 border border-astro-border/70 shadow-soft text-left transition-transform duration-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-astro-highlight/40 hover:-translate-y-0.5 group"
            >
                <div className="flex items-start justify-between mb-3">
                    ...
                    <div className="flex-shrink-0 w-12 h-12 rounded-2xl bg-astro-bg/70 border border-astro-border/60 flex items-center justify-center group-hover:scale-105 transition-transform">
            ...
            <button 
                ...
                className="w-full bg-astro-card rounded-2xl p-6 border border-astro-border/70 text-left shadow-soft transition-transform duration-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-astro-highlight/40 hover:-translate-y-0.5 group"
            >
            ...
            <div className="grid grid-cols-2 gap-4">
                ...
                <button 
                    ...
                    className="relative bg-astro-card p-5 rounded-2xl border border-astro-border/70 text-left shadow-soft transition-transform duration-200 hover:-translate-y-0.5 focus:outline-none focus-visible:ring-2 focus-visible:ring-astro-highlight/40 group"
                >
                    <div className="flex flex-col justify-between h-28">
                        <div className="w-10 h-10 rounded-2xl bg-astro-bg/70 border border-astro-border/60 flex items-center justify-center group-hover:scale-105 transition-transform">
