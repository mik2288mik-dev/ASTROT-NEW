    ...
    return (
        <div className="p-4 pb-32 space-y-6">
            ...
            <button 
                ...
                className="w-full bg-astro-card rounded-2xl p-6 shadow-soft relative overflow-hidden text-left active:opacity-80 transition-opacity group"
            >
                <div className="absolute -top-16 -left-16 w-48 h-48 bg-purple-500 rounded-full blur-3xl opacity-10"></div>
                <div className="relative z-10">
            ...
            <button 
                ...
                className="w-full bg-astro-card rounded-2xl p-6 text-left shadow-soft group relative overflow-hidden active:opacity-80 transition-opacity"
            >
                <div className="absolute -top-16 -left-16 w-48 h-48 bg-purple-500 rounded-full blur-3xl opacity-10"></div>
                <div className="relative z-10">
            ...
            <div className="grid grid-cols-2 gap-4">
                ...
                <button 
                    ...
                    className="bg-astro-card p-5 rounded-2xl text-left shadow-soft group relative overflow-hidden active:opacity-80 transition-opacity"
                >
                    <div className="absolute -top-10 -right-10 w-32 h-32 bg-pink-500 rounded-full blur-2xl opacity-10"></div>
                ...
                <button 
                    ...
                    className="bg-astro-card p-5 rounded-2xl text-left shadow-soft group relative overflow-hidden active:opacity-80 transition-opacity"
                >
                    <div className="absolute -top-10 -right-10 w-32 h-32 bg-blue-500 rounded-full blur-2xl opacity-10"></div>
