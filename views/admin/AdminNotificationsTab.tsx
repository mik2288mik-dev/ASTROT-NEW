...
const AI_DRAFT_SCENARIOS: Array<{
  ...
  },
  {
    ...
    hintRu: 'Продать полный и точный разбор дня через Lumia Premium.',
    hintEn: 'Sell the full precise day reading through Lumia Premium.',
  },
  {
    value: 'promo',
    labelRu: 'Промо',
    labelEn: 'Promo',
    hintRu: 'Промо Premium-разборов, совместимости и глубоких материалов.',
    hintEn: 'Promote Premium readings, compatibility, and deeper materials.',
  },
  {
    value: 'reactivation',
    labelRu: 'Возврат',
