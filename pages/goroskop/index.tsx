...
const faq = [
  {
    ...
    answer: 'Прогноз по солнечному знаку общий. Личный прогноз NEBO использует выбранный период, данные сохранённой натальной карты и предыдущие тексты.',
  },
  {
...
export default function HoroscopeHubPage() {
  return (
    <PublicSeoPage
      ...
      description="Гороскоп по 12 знакам зодиака в NEBO: понятные страницы Овна, Тельца, Близнецов и остальных знаков плюс личный прогноз по натальной карте."
    ...
    >
      ...
      <section>
        ...
        <p>Страницы ниже содержат постоянные объяснения знаков. Ежедневный гороскоп обновляется внутри NEBO и доступен бесплатно.</p>
        <ReleaseAction />
      </section>
    </PublicSeoPage>
  );
