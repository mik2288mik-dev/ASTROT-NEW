...
export default function SignCompatibilityPairPage({
  ...
  const faq = [
    ...
    },
    {
      ...
      answer: 'Сохранить две натальные карты по дате, времени и месту рождения и открыть совместимость по рассчитанным картам в MEOU Premium.',
    },
  ];
  ...
  return (
    <PublicSeoPage
      ...
      description={`Совместимость ${pairNamesGenitive(pair)}: что сближает два знака, где расходится темп и как говорить яснее. Общий бесплатный разбор MEOU.`}
    ...
    >
      ...
      <section>
        ...
        <p>Полная совместимость использует рассчитанные натальные карты обоих людей. Этот формат доступен в MEOU Premium.</p>
        <ReleaseAction />
      </section>
    </PublicSeoPage>
  );
