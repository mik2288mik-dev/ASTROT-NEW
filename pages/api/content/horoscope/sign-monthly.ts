...
import { getMoscowMonthKey, isValidMoscowMonthKey } from '../../../../lib/date-utils';
...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  const periodKey = isValidMoscowMonthKey(requestedPeriod) ? requestedPeriod : getMoscowMonthKey();
