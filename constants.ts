...
export const TRANSLATIONS = {
  ru: {
    ...
    basic_result: {
      ...
      full_loading: "Открываем разбор...",
      pro_loading: "Открываем профессиональный разбор...",
      pro_locked: "Сначала откройте полный разбор",
      ascendant_unavailable: "Асцендент недоступен без точного времени рождения",
      not_found: "Карта не найдена",
      error_generic: "Не удалось выполнить операцию",
      back: "Назад"
    },
    full_report: {
      title: "Полный разбор",
      unavailable: "Разбор недоступен",
      unavailable_desc: "Для этой карты полный разбор пока не открыт.",
      personality: "Личность",
      emotions: "Эмоции и чувства",
      relationships: "Отношения",
      career: "Карьера",
      karmic_vector: "Кармический вектор",
      summary: "Итог",
      back: "Назад"
    },
    pro_report: {
      title: "Профессиональный разбор",
      unavailable: "Профессиональный разбор недоступен",
      unavailable_desc: "Для этой карты профессиональный разбор пока не открыт.",
      planets: "Планеты",
      houses: "Дома",
      aspects: "Аспекты",
      nodes: "Лунные узлы",
      lilith: "Лилит",
      chiron: "Хирон",
      configuration: "Конфигурация карты",
      dominant_patterns: "Доминантные паттерны",
      karmic_themes: "Кармические темы",
      retrograde: "ретро",
      house_label: "дом",
      orb: "орб",
  ...
  en: {
    ...
    basic_result: {
      ...
      full_loading: "Opening report...",
      pro_loading: "Opening professional report...",
      pro_locked: "Unlock full report first",
      ascendant_unavailable: "Ascendant unavailable without exact birth time",
    ...
    full_report: {
      ...
      unavailable_desc: "The full report has not been unlocked for this card.",
      personality: "Personality",
      emotions: "Emotions",
      relationships: "Relationships",
      career: "Career",
      karmic_vector: "Karmic Vector",
      summary: "Summary",
      back: "Back"
    },
    pro_report: {
      title: "Professional Report",
      unavailable: "Professional report unavailable",
      unavailable_desc: "The professional report has not been unlocked for this card.",
      planets: "Planets",
      houses: "Houses",
      aspects: "Aspects",
      nodes: "Lunar Nodes",
      ...
      dominant_patterns: "Dominant Patterns",
      karmic_themes: "Karmic Themes",
      retrograde: "retro",
      house_label: "house",
      orb: "orb",
