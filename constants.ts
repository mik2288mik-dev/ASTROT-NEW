...
export const TRANSLATIONS = {
  ru: {
    ...
    oracle: {
      ...
      placeholder: "Задай важный вопрос...",
      intro: "Я уже вижу твою карту. Если есть вопрос про отношения, выбор, тревогу или направление, задай его прямо."
    },
    horoscope: {
  ...
  en: {
    ...
    oracle: {
      ...
      intro: "I already see your chart. If there is a question about relationships, decisions, pressure, or direction, ask it directly."
    },
    horoscope: {
