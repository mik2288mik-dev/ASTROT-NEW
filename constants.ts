...
export const TRANSLATIONS = {
  ru: {
    ...
    dashboard: {
      ...
      hero_label: "Твой день",
      hero_title_ready: "Сегодняшний слой уже готов",
      hero_title_energy: "Время действовать и проявлять себя",
      hero_title_clarity: "День ясности и движения вперёд",
      hero_subtitle: "Личный ориентир через твою натальную карту",
      hero_cta: "Открыть день",
      feature_forecast_sub: "День через твою карту",
      feature_premium_sub: "Глубина и темы карты",
      weather_strip_set_city: "Укажите город в настройках",
      secondary_oracle_title: "Оракул Lumia",
      secondary_oracle_sub: "Задай вопрос — ответ опирается на твою карту",
      nav_home: "Главная",
      nav_chart: "Карта",
      nav_day: "День",
      nav_charts: "Карты"
  ...
  en: {
    ...
    dashboard: {
      ...
      hero_label: "Your day",
      hero_title_ready: "Today’s layer is ready",
      hero_title_energy: "Time to act and show up",
      hero_title_clarity: "A day of clarity and forward motion",
      hero_subtitle: "Personal guidance through your natal chart",
      hero_cta: "Open today",
      feature_forecast_sub: "Today through your chart",
      feature_premium_sub: "Depth and chart themes",
      weather_strip_set_city: "Set city in settings",
      secondary_oracle_title: "Lumia Oracle",
      secondary_oracle_sub: "Ask a question — answers align with your chart",
      nav_home: "Home",
      nav_chart: "Chart",
      nav_day: "Today",
      nav_charts: "Charts"
