...
export const TRANSLATIONS = {
  ru: {
    ...
    dashboard: {
      ...
      synastry_subtitle: "Три слоя: бесплатный вход, Lumi, Premium",
      synastry_hint: "Бесплатно — короткий фон. Средний слой за Lumi. Полный разбор — в Premium.",
    ...
    synastry: {
      ...
      desc: "Короткий слой бесплатно задаёт общий фон. Средний разбор за Lumi добавляет напряжение, смысл и практичные опоры. Полный Premium — глубокий слой. Подходит для романтики, дружбы, семьи и рабочих связей — укажите тип отношений ниже.",
      ...
      extended_btn: "Средний разбор ({cost} Lumi)",
      full_btn: "Полный разбор (Premium)",
      extended_hint: "Глубже бесплатного слоя: связь, напряжение, как обходиться друг с другом. Разовое списание Lumi после подтверждения.",
      lumi_consent: "Согласен(на) списать {cost} Lumi за средний разбор для этой пары",
      error_lumi_consent: "Отметьте согласие на списание Lumi или выберите другой слой.",
      error_insufficient_lumi: "Недостаточно Lumi для среднего разбора.",
      error_lumi_required: "Средний слой открывается за Lumi. Отметьте согласие ниже и нажмите снова.",
      ...
      add_extended_btn: "Добавить средний слой ({cost} Lumi)",
    ...
    settings: {
      ...
      dashboard_air_title: "AIR style for dashboard",
      dashboard_air_body: "Switch dashboard versions and compare which rhythm works best.",
      dashboard_air_cloud_ribbon: "Cloud Ribbon",
      dashboard_air_aero_stack: "Aero Stack",
      dashboard_air_orbit_focus: "Orbit Focus",
      dashboard_air_feather_cards: "Feather Cards",
      dashboard_air_pulse_air: "Pulse AIR",
      language_ru: "Русский",
      language_en: "English",
    ...
    oracle: {
      ...
      state_premium_body: "Это другой класс ответа: глубже, спокойнее и ближе к тому, что в тебе сейчас по-настоящему происходит.",
  ...
  en: {
    ...
    dashboard: {
      ...
      synastry_subtitle: "Three layers: free, Lumi, Premium",
      synastry_hint: "Free for the short entry. Mid layer for Lumi. Full depth in Premium.",
    ...
    synastry: {
      ...
      desc: "The free layer sets the overall tone. The mid layer (Lumi) adds tension, meaning, and practical handles. Premium is the deep layer. Works for romance, friendship, family, and work — pick the bond type below.",
      ...
      extended_btn: "Mid layer ({cost} Lumi)",
      full_btn: "Full layer (Premium)",
      extended_hint: "Deeper than free: connection, tension, and how to move together. One Lumi charge after you confirm.",
      lumi_consent: "I agree to spend {cost} Lumi on the mid layer for this pair",
      error_lumi_consent: "Confirm Lumi spend or choose another layer.",
      error_insufficient_lumi: "Not enough Lumi for the mid layer.",
      error_lumi_required: "The mid layer costs Lumi. Check the consent below and tap again.",
      ...
      add_extended_btn: "Add mid layer ({cost} Lumi)",
    ...
    settings: {
      ...
      dashboard_air_title: "Dashboard AIR style",
      dashboard_air_body: "Switch dashboard versions and compare which visual rhythm fits Lumia best.",
      dashboard_air_cloud_ribbon: "Cloud Ribbon",
      dashboard_air_aero_stack: "Aero Stack",
      dashboard_air_orbit_focus: "Orbit Focus",
      dashboard_air_feather_cards: "Feather Cards",
    ...
    oracle: {
      ...
      state_premium_body: "This is a different class of answer: deeper, steadier, and closer to what is really moving in you right now.",
