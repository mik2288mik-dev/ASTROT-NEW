...
export const TRANSLATIONS = {
  ru: {
    ...
    dashboard: {
      ...
      identity_body: "Личная карта уже построена по твоим данным рождения. Здесь начинается твой базовый уровень Lumia.",
      hero_label: "Сегодня",
      hero_fallback_title: "Сегодня важно держаться за главное",
      hero_body: "Личный прогноз на день показывает, где сейчас опора, где напряжение и на чём лучше сосредоточиться.",
      hero_cta: "Открыть прогноз дня",
      matters_label: "Ориентиры дня",
      matters_title: "Что важно сегодня",
      matters_body: "Коротко о том, где сегодня шанс, где напряжение и на чём лучше держать внимание.",
      chance: "Шанс",
      risk: "Риск",
      focus: "Фокус",
      ...
      natal_body: "Характер, стиль отношений, сильные стороны и повторяющиеся жизненные сценарии. Это твой базовый личный разбор, который уже сохранён в профиле.",
      natal_note: "Базовый разбор остаётся с тобой. Позже ты сможешь открыть новый ракурс или пересчёт точечно через Lumi.",
  ...
  en: {
    ...
    dashboard: {
      ...
      identity_body: "Your chart is already built from your birth data. This is where your core Lumia layer begins.",
      hero_label: "Today",
      hero_fallback_title: "Today is about holding on to what matters",
      hero_body: "Your daily reading shows where your support is, where pressure may rise, and what deserves your attention first.",
      hero_cta: "Open today’s forecast",
      matters_label: "Daily cues",
      matters_title: "What matters today",
      matters_body: "A short practical read on where the opening is, where tension can build, and what needs your focus.",
      chance: "Chance",
      risk: "Risk",
      focus: "Focus",
      ...
      natal_body: "Character, relationship style, strengths, and repeating life patterns. This is your personal base reading, already saved in your profile.",
