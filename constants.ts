...
export const TRANSLATIONS = {
  ru: {
    ...
    horoscope: {
      ...
      subtitle: "Ежедневные ориентиры через твою натальную карту.",
      today_layer_label: "Ежедневный слой",
      loading: "Собираю твой день…",
      ...
      reading_body: "Персональный срез: натальная карта и небо сегодня.",
      foundation_label: "Твоя основа",
      foundation_body: "Солнечный знак задаёт общий тон, а текст дня опирается на твою натальную карту.",
      context_title: "Контекст неба",
      context_body: "Луна и главный акцент дня помогают понять, почему всё ощущается именно так.",
      moon_impact_title: "Луна сегодня",
      transit_focus_title: "Главный акцент дня",
      advice_title: "Три опоры дня",
      ...
      empty_title: "Сегодняшний слой пока недоступен",
      empty_body: "Дневной текст не загрузился, но натальная карта по-прежнему твоя опора.",
  ...
  en: {
    ...
    horoscope: {
      ...
      subtitle: "Daily cues through your natal chart.",
      ...
      reading_body: "A personal slice of your chart against today’s sky.",
      foundation_label: "Your foundation",
      foundation_body: "Your Sun sign sets the overall tone, and the daily text stays grounded in your natal chart.",
      context_title: "Sky context",
      context_body: "The Moon and today’s main emphasis help explain why the day feels the way it does.",
      moon_impact_title: "Moon today",
      transit_focus_title: "Today’s main emphasis",
      ...
      empty_title: "Today’s layer isn’t available yet",
      empty_body: "The daily text didn’t load, but your natal chart is still your anchor.",
