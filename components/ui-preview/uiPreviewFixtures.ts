...
export function createUiPreviewNatalCatalog(): UiPreviewNatalCatalog {
  ...
  for (const category of NATAL_REPORT_CATEGORIES) {
    ...
    categoryPacks[category.key] = {
      ...
      ...(category.key === 'main' ? {
        story: {
          text: 'Ты быстро замечаешь, где за словами есть настоящий интерес, а где разговор держится только на вежливости, поэтому сначала присматриваешься и не спешишь раскрываться. С близкими эта осторожность исчезает: ты живее шутишь, прямее споришь и ждёшь такой же ответной инициативы. В делах тебе проще разогнаться, когда понятен результат, зато после старта ты умеешь долго держать одну задачу. И в покупках ты выбираешь не красивое обещание, а вещь, которая будет хорошо работать каждый день.',
          evidenceIds: [...new Set(summary.flatMap((paragraph) => paragraph.evidenceIds))],
        },
        premiumStory: {
          text: 'Ты производишь впечатление человека, который сначала смотрит и слушает, а уже потом решает, стоит ли подпускать ближе. В новых разговорах не спешишь раскрываться, поэтому кому-то можешь показаться жёсткой или закрытой. Но это не равнодушие: ты тонко ловишь настроение, быстро замечаешь нестыковку между словами и поступками и не любишь делать вид, что ничего не происходит.\n\nТебе действительно нужно своё пространство. После долгих разговоров, суеты или чужих ожиданий хочется уйти в тишину и собрать себя заново. С близкими при этом ты совсем другая: живее шутишь, прямее споришь, сильнее включаешься. Дом, привычные люди и ощущение, что есть куда вернуться, дают тебе не красивую картинку, а спокойствие.\n\nВ делах ты хорошо видишь, где всё разваливается, и быстро понимаешь, что нужно поправить. Тебе легче включиться, когда есть понятный результат, но совсем однообразная работа быстро гасит интерес. В голове одновременно живут желание всё разложить по местам и потребность делать что-то по-своему — поэтому скучная предсказуемость утомляет, а сложная задача, в которой можно разобраться и собрать систему, наоборот цепляет.\n\nС деньгами у тебя может быть смешанный режим: ты умеешь считать и видеть слабые места решения, но иногда желание порадовать себя или близких приходит раньше расчёта. В отношениях важны не громкие слова, а действие: продолженный разговор, встреча, готовность не исчезнуть при первом неудобстве. Интерес быстро загорается там, где есть живой обмен и ответная инициатива; долго тащить всё в одиночку тебе не нравится.\n\nВ тебе есть противоречие: одна часть хочет тишины, глубины и возможности исчезнуть от всех, а другая требует движения, новых идей и нескольких дел сразу. Из-за этого легко набрать слишком много, а потом резко понять, что сил уже нет. Твоя сила не в том, чтобы контролировать каждую мелочь, а в умении замечать суть, перестраиваться и не терять себя, когда вокруг всё меняется.',
          evidenceIds: [...new Set(summary.flatMap((paragraph) => paragraph.evidenceIds))],
        },
      } : {}),
      followUps,
