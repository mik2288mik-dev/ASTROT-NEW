...
export const NotificationScheduleEditor = memo<NotificationScheduleEditorProps>(({ rows, onChange }) => {
  ...
  return (
    <div className="space-y-2">
      <p className="text-xs font-medium text-astro-subtext">Время отправки (каждый день)</p>
      {rows.map((row, index) => (
