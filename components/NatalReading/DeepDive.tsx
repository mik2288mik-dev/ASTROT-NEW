...
const DIVE_TOPICS: DiveTopic[] = [
  {
    ...
    preview:
      'Ты ищешь не страсть, а человека, с которым можно выдохнуть. И при этом твоя сдержанность может пугать — люди иногда видят в тебе больше, чем ты успеваешь показать.',
  },
  {
    key: 'career',
    Icon: Briefcase,
