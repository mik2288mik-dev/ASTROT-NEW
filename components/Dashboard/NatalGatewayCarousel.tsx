        ...
        language === 'en'
          ? [
              ...
              },
              {
                ...
                subtitle: 'Start with the zodiac forecast. Personal chart readings open with Premium or Lumi.',
                cta: 'Open horoscope',
                chips: ['Zodiac', 'Moon', 'Chart readings'],
          ...
          : [
              ...
              },
              {
                ...
                subtitle: 'Сначала прогноз по знаку. Личные разборы по карте — в Premium или за Lumi.',
                cta: 'Открыть гороскоп',
                chips: ['Знак', 'Луна', 'Личная карта'],
                image: '/natal-gateway/daily-horoscope.webp',
                tone: 'sky',
                action: onOpenHoroscope,
              },
