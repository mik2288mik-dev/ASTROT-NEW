...
const OVERLAYS_BY_VIEW: Partial<Record<ViewState, OverlayLayer[]>> = {
  hook: [{ src: overlayVioletGlow, opacity: 0.2 }],
  paywall: [
    { src: overlayGoldGlow, opacity: 0.2 },
    { src: overlayLightRays, opacity: 0.12 }
  ],
  dashboard: [{ src: overlaySoftFog, opacity: 0.16 }],
  horoscope: [{ src: overlaySparkles, opacity: 0.18 }],
  settings: [{ src: overlayGoldGlow, opacity: 0.12 }],
  admin: [{ src: overlayGoldGlow, opacity: 0.12 }]
};
