...
export function NeboDashboard(props: Props) {
  ...
  const openPremium = () => void onRequestPremium?.(period === 'day' ? 'today' : period, { placement: period === 'day' ? 'today' : period, featureKey: 'personal_daily_full', triggerType: 'locked_feature', returnView: 'dashboard' });
