...
const reactivation = [
  t('👋 Твой день уже собран — без тебя', 'Зайди на минуту: что сегодня сделать, а что отпустить. Коротко и без воды.', 'Открыть', ['reactivation']),
  t('👋 LUMIA не потерялась', 'Новый день, новый ритм и одна понятная подсказка ждут внутри.', 'Вернуться', ['reactivation']),
  t('🔄 Пора обновить твой ритм', 'Один check-in — и подсказки снова станут точными.', 'Открыть', ['reactivation', 'checkin']),
  t('✨ Сегодняшний разбор уже ждёт', 'Без длинных текстов: темп дня, лучший момент и вечерняя отметка.', 'Вернуться', ['reactivation']),
  t('🍃 Можно зайти мягко', 'Покажем сегодняшний ритм — без давления и лишнего шума.', 'Открыть сегодня', ['reactivation', 'calm']),
  t('🗓 Новый день собран', '{{main_title}}\n\nЗагляни на минуту, чтобы поймать свой темп.', 'Посмотреть', ['reactivation']),
  t('👋 Давай без большого возвращения', 'Просто открой сегодняшний день и забери один полезный ориентир.', 'Открыть LUMIA', ['reactivation']),
  t('🔄 Ритм можно вернуть за минуту', 'Пара тапов сегодня — и подсказки снова станут ближе к тебе.', 'Обновить ритм', ['reactivation']),
];
