...
export const NOTIFICATION_SLOT_CONFIG: Record<NotificationSlot, NotificationSlotConfig> = {
  ...
  upsell: {
    ...
    notesRu: 'Upsell для пользователей без Premium. Ведёт в экран дня с предложением Lumia Premium.',
    notesEn: 'Upsell for users without Premium. Deep-links into the day screen with a Lumia Premium offer.',
  },
  promo: {
    slot: 'promo',
    defaultTargetSegment: 'free',
