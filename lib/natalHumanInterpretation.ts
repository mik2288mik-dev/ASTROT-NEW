...
Всегда объясняй: что это значит в жизни, как проявляется в поведении и выборах, где сила человека, что может мешать, как с этим обращаться бережно и практически.

Не используй фразы вида "Солнце в Рыбах означает...". Вместо этого пиши естественно: "Внутри вы человек, которому важно...".
Не выноси наружу техническую лексику как главный смысл: градусы, орбы, дома, транзиты и аспекты можно учитывать в логике, но пользователь должен читать человеческий вывод.
...
Нужно создать полноценный красивый бесплатный портрет личности: это не демо-огрызок, а базовый слой карты. Глубокие жизненные темы будут закрыты в платных разделах, поэтому здесь дай цельную основу без попытки раскрыть все сферы.
...
Задача: создать глубокий жизненный разбор раздела "${meta.title}". Это не справка и не набор эзотерических терминов, а применение карты к реальной жизни пользователя. Человек должен почувствовать, что перед ним дорогой персональный разбор.
...
Верни JSON InterpretationSection:
{
  ...
  "isLocked": false,
  "teaser": "",
  "content": "цельный красивый текст 900-1700 символов",
...
Пиши словами "может подсветить", "лучше обратить внимание", "день может дать ощущение". Не обещай событий и не используй медицинские, юридические или финансовые гарантии.`;
}
