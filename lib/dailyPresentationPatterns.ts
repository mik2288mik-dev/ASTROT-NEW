...
const DASHBOARD_SYSTEM_COPY: Record<DashboardSystemState, Record<Locale, string[]>> = {
  loading: {
    ru: [
      ...
      'Личный гороскоп уже в работе. Без тумана и общих фраз.',
    ...
    en: [
      ...
      'Your personal horoscope is in progress. No fog, no generic filler.',
  ...
  generation_error: {
    ru: [
      ...
      'Не получилось собрать личный гороскоп. Повтори попытку через минуту.',
    ...
    en: [
      ...
      'Your personal horoscope could not be prepared. Try again in a minute.',
