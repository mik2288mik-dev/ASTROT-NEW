      ...
      ru: {
        ...
        sections: [
          ...
          },
          {
            title: 'Как её читать',
            paragraphs: [
              'Каждая часть карты отвечает на свой вопрос. Планета показывает, о чём идёт речь, знак — каким способом, дом — в какой области жизни, а аспект — как это связано с другой планетой.',
            ],
          },
        ],
      ...
      ru: {
        ...
        sections: [
          ...
          },
          {
            ...
            paragraphs: [
              'Неточное время может изменить градусы углов и положение планет по домам. Поэтому важно честно отмечать, что время указано приблизительно.',
            ],
          },
        ],
