...
export const SIGN_TOPICS = [
  {
    ...
    copy: {
      ru: {
        ...
        sections: [
          { title: 'Знак отвечает на вопрос «как»', paragraphs: ['Планета показывает, о чём идёт речь, а знак задаёт привычный способ действия. Поэтому один и тот же знак читается по-разному у Солнца, Луны или Марса.'] },
  ...
  },
  {
    ...
    copy: {
      ru: {
        ...
        summary: 'Планета показывает, о чём идёт речь, а знак описывает способ действия.',
        sections: [
        ...
        shortAnswer: 'Сначала уточните значение планеты, затем добавьте способ действия её знака.',
      },
      en: {
