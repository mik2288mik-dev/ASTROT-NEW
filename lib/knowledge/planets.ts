...
export const PLANET_TOPICS = [
  ...
  },
  {
    ...
    copy: {
      ru: {
        title: 'Луна',
        summary: 'Луна в натальной карте — положение естественного спутника Земли на момент рождения. В астрологии её связывают с привычными эмоциональными реакциями, повседневными привычками и отношением к заботе.',
        sections: [
          {
            title: 'Что читают по Луне',
            paragraphs: [
              'По Луне обсуждают непосредственную реакцию на происходящее, бытовые привычки и знакомые способы давать и принимать заботу. Речь идёт о быстром эмоциональном отклике, а не о заранее принятом решении или постоянном настроении.',
            ],
          },
          {
            title: 'Что уточняет положение',
            paragraphs: [
              'Знак Луны, то есть участок зодиака, в котором она находилась при рождении, описывает форму эмоционального отклика. Дом, одна из двенадцати частей круга карты, указывает на жизненные вопросы, где привычные реакции заметны чаще. Аспекты, то есть связи Луны с другими точками карты, показывают, как эта тема сочетается с мышлением, решениями и отношениями.',
            ],
          },
        ],
        shortAnswer: 'Луну в натальной карте связывают с привычными реакциями, бытовыми привычками и способом давать и принимать заботу.',
      },
      en: {
        title: 'The Moon',
  ...
  },
  {
    ...
    copy: {
      ru: {
        title: 'Хирон',
        summary: 'Хирон — малое небесное тело, положение которого отмечают в натальной карте. В астрологии его используют как дополнительную деталь при чтении чувствительных вопросов и реакции на них.',
        sections: [
          {
            title: 'Что читают по Хирону',
            paragraphs: [
              'Положение Хирона используют, чтобы обсуждать вопросы, в которых человек особенно остро замечает уязвимость или недостаток опыта. Это дополнительная деталь карты, а не диагноз, медицинский вывод или доказательство пережитой травмы.',
            ],
          },
          {
            title: 'Что уточняет положение',
            paragraphs: [
              'Знак Хирона часто совпадает у людей близких лет рождения. Для более личного чтения смотрят на дом, одну из двенадцати частей круга карты, и точные аспекты Хирона с Солнцем, Луной и другими точками карты. Одного знака Хирона недостаточно для отдельного вывода.',
            ],
          },
        ],
        shortAnswer: 'Хирон используют как дополнительную деталь при чтении чувствительных вопросов; он не служит диагнозом и не доказывает наличие травмы.',
      },
      en: {
        title: 'Chiron',
