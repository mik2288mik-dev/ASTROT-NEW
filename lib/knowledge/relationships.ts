  ...
  },
  {
    ...
    copy: {
      ru: {
        ...
        summary: 'Синастрия — способ сравнить две натальные карты. Для этого рассчитывают аспекты между планетами и другими точками карт двух людей.',
        sections: [
          {
            title: 'Как устроено сравнение',
            paragraphs: [
              'Положение каждой планеты сначала рассчитывают в собственной карте. Затем программа находит аспекты между точками двух карт. По виду этих связей в астрологии описывают возможные сходства и различия в мышлении, чувствах, симпатии и действиях.',
            ],
          },
          {
        ...
        shortAnswer: 'Синастрия сравнивает аспекты между двумя натальными картами, но не выставляет паре оценку и не предсказывает итог отношений.',
      },
      en: {
