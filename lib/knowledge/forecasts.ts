        ...
        sections: [
          {
            ...
            paragraphs: [
              'Положения планет в натальной карте рассчитываются по дате, времени и месту рождения. Этот расчёт не меняется каждый день. Он используется как личный контекст для разговора о привычных реакциях и способах выбора.',
            ],
          },
          {
