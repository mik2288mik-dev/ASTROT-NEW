...
export const ASPECT_TOPICS = [
  {
    ...
    copy: {
      ru: {
        title: 'Аспекты',
        summary: 'Аспект — это связь между двумя планетами или другими точками натальной карты. По ней в астрологии описывают, легко ли сочетаются значения этих частей карты или мешают друг другу.',
        sections: [
          {
            title: 'Как аспект находят на карте',
            paragraphs: [
              'Планеты занимают разные места на круге карты. Программа сравнивает каждую пару и отмечает несколько известных видов связи: соединение, секстиль, квадрат, трин или оппозицию.',
            ],
          },
          {
            title: 'Как читать аспект',
            paragraphs: [
              'Сначала смотрят, какие две планеты связаны. Затем учитывают вид аспекта и орб — насколько точно планеты заняли нужное для него положение. Знаки, дома и остальные связи уточняют смысл, поэтому одной линии на карте недостаточно для вывода.',
            ],
          },
        ],
        shortAnswer: 'Аспект связывает две планеты или точки карты и помогает понять, легко ли их значения сочетаются или требуют согласования.',
      },
      en: {
        title: 'Aspects',
