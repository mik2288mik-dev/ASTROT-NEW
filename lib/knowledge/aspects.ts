...
export const ASPECT_TOPICS = [
  ...
  },
  {
    ...
    copy: {
      ru: {
        title: 'Квадрат',
        summary: 'Квадрат — это связь между двумя планетами или точками карты, расположенными примерно под прямым углом друг к другу. В астрологии такой аспект показывает, что их значения трудно включать одновременно.',
        sections: [
          {
          ...
          },
          {
            ...
            paragraphs: [
              'Сначала смотрят, какие планеты образуют квадрат. Потом — в каких знаках и домах они стоят и насколько точен аспект. Без этого фраза «в карте есть квадрат» почти ничего не объясняет.',
            ],
          },
        ],
