        ...
        sections: [
          {
            ...
            paragraphs: [
              'Знак Луны показывает привычный тон эмоционального ответа. Дом уточняет область жизни, где этот ответ особенно заметен, если время рождения известно достаточно точно. Аспекты показывают связи Луны с другими планетами.',
            ],
          },
          {
