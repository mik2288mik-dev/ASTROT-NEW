...
export const MOON_CYCLE_TOPICS = [
  {
    ...
    copy: {
      ru: {
        ...
        summary: 'Натальная Луна описывает привычные эмоциональные реакции, способы заботы и условия, в которых легче успокоиться.',
        sections: [
          {
            title: 'Положение на момент рождения',
            paragraphs: [
              'Знак Луны показывает привычный тон эмоционального ответа. Дом уточняет область жизни, где этот ответ особенно заметен, если время рождения известно достаточно точно. Аспекты связывают Луну с другими функциями карты.',
            ],
          },
          {
        ...
        shortAnswer: 'Натальная Луна относится к привычному эмоциональному ответу, а не к настроению конкретного дня.',
      },
      en: {
    ...
    personalizationKind: { type: 'planet', key: 'moon' },
  },
  {
    id: 'current-moon',
    category: 'moon-cycles',
    ...
    copy: {
      ru: {
        title: 'Текущая Луна',
        summary: 'Текущая Луна быстро движется по зодиаку и показывает её положение для выбранного момента.',
        sections: [
          {
            title: 'Чем она отличается от натальной',
            paragraphs: [
              'Натальная Луна фиксируется на момент рождения. Текущая Луна продолжает движение и примерно за месяц проходит весь зодиак. В геоцентрическом расчёте её знак зависит от выбранного момента, а не от личной натальной карты.',
            ],
          },
          {
        ...
        shortAnswer: 'Текущая Луна описывает общий момент неба, а натальная Луна остаётся личной точкой карты рождения.',
      },
      en: {
  ...
  },
  {
    ...
    copy: {
      ru: {
        ...
        summary: 'Фаза показывает, какую долю освещённой Солнцем стороны Луны видно с Земли.',
        sections: [
          {
        ...
        shortAnswer: 'Фаза Луны определяется её положением относительно Земли и Солнца.',
      },
      en: {
  ...
  },
  {
    ...
    copy: {
      ru: {
        title: 'Новолуние',
        summary: 'Новолуние наступает, когда Солнце и Луна находятся почти в одном направлении от Земли.',
        sections: [
          {
          ...
          },
          {
            ...
            paragraphs: [
              'Новолуние принимают за начало нового лунного цикла. В астрологической традиции его связывают с новым началом, но это символическая трактовка, а не гарантия события или результата.',
            ],
          },
        ],
        shortAnswer: 'Новолуние является астрономическим началом лунного цикла, когда видимая часть диска минимальна.',
      },
      en: {
        title: 'New moon',
  ...
  },
  {
    ...
    copy: {
      ru: {
        title: 'Полнолуние',
        summary: 'Полнолуние наступает, когда Земля находится примерно между направлениями на Солнце и Луну.',
        sections: [
          {
        ...
        shortAnswer: 'Полнолуние является точкой цикла, когда с Земли видна почти вся освещённая сторона Луны.',
      },
      en: {
        title: 'Full moon',
      ...
      ru: {
        ...
        sections: [
          ...
          },
          {
            ...
            paragraphs: [
              'В астрологических календарях эту часть цикла связывают с продолжением начатого. Это символическая трактовка, она не сообщает, будет ли дело успешным.',
            ],
          },
        ],
  ...
  },
  {
    ...
    copy: {
      ru: {
        ...
        summary: 'Убывающей называют Луну в части цикла от полнолуния к следующему новолунию.',
        sections: [
          {
          ...
          },
          {
            title: 'Традиционное чтение',
            paragraphs: [
              'В астрологических календарях убывающую часть цикла часто связывают с завершением и пересмотром. Такой образ не требует отменять новые дела и не предсказывает потерю или спад.',
            ],
          },
        ],
  ...
  },
  {
    ...
    copy: {
      ru: {
        ...
        summary: 'Полный цикл от одного новолуния до следующего длится примерно 29,5 суток и проходит одни и те же фазы.',
        sections: [
          {
        ...
        shortAnswer: 'Лунный календарь переводит непрерывный цикл примерно в 29,5 суток в даты и названия фаз.',
      },
      en: {
