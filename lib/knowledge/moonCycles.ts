...
export const MOON_CYCLE_TOPICS = [
  ...
  },
  {
    ...
    copy: {
      ru: {
        title: 'Полнолуние',
        summary: 'Полнолуние — фаза, при которой Луна находится примерно напротив Солнца на земном небе, а с Земли видна почти вся её освещённая Солнцем половина. Точная фаза наступает в один момент, хотя диск выглядит полным дольше.',
        sections: [
          {
            title: 'Что происходит физически',
            kind: 'fact',
            paragraphs: [
              'Солнце освещает половину Луны постоянно. Во время полнолуния освещённая половина почти полностью обращена к Земле, поэтому видимый диск выглядит круглым и ярким. Луна не становится полнее и не меняет форму.',
            ],
          },
          {
            title: 'Почему цикл занимает около 29,5 суток',
            kind: 'mechanism',
            paragraphs: [
              'Пока Луна обращается вокруг Земли, Земля сама движется вокруг Солнца. Чтобы снова получить ту же геометрию освещения, Луне требуется в среднем около двадцати девяти с половиной суток от одного полнолуния до следующего.',
            ],
          },
          {
            title: 'Что означает оппозиция Солнца и Луны',
            kind: 'calculation',
            paragraphs: [
              'В геоцентрической записи их эклиптические долготы различаются примерно на сто восемьдесят градусов. Поэтому астрологи называют полнолуние оппозицией Солнца и Луны. Это угол на небесной сфере, видимый с Земли.',
            ],
          },
          {
            title: 'Почему не каждое полнолуние — затмение',
            kind: 'mechanism',
            paragraphs: [
              'Орбита Луны наклонена к эклиптике. В большинстве полнолуний Луна проходит выше или ниже земной тени. Лунное затмение происходит только тогда, когда полнолуние оказывается достаточно близко к одному из лунных узлов.',
            ],
          },
          {
            title: 'В астрологии',
            kind: 'astrology',
            paragraphs: [
              'Полнолуние связывают с кульминацией, проявлением результата или напряжением между двумя сторонами темы. Для конкретной трактовки смотрят знак, дом и аспекты фазы. Это символическое чтение и оно не означает обязательного конфликта или резкой перемены настроения у каждого человека.',
            ],
          },
          {
            title: 'Часто путают',
            kind: 'confusion',
            paragraphs: [
              'Полнолуние — обычная фаза освещения. Лунное затмение — прохождение Луны через тень Земли. «Полная Луна» на фотографии может быть снята за несколько часов до или после точного астрономического момента.',
            ],
          },
        ],
        shortAnswer: 'Полнолуние — момент, когда с Земли видна почти вся освещённая половина Луны. Это не затмение, если Луна не входит в земную тень.',
      },
      en: {
        title: 'Full moon',
    ...
    relatedTopicIds: ['planet-moon', 'lunar-cycle', 'moon-phase', 'new-moon', 'lunar-eclipse', 'aspect-opposition'],
    diagram: 'moon-phases',
    sourceIds: ['nasa-moon-phases', 'nasa-eclipses'],
  },
  {
    id: 'waxing-moon',
    category: 'moon-cycles',
