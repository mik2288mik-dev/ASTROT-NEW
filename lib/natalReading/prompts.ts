...
- Не используешь продающие слова: «глубина», «слой», «премиум», «магия», «избранность».
- Без эмодзи и декоративных символов внутри текста.
- Короткие предложения, нормальные абзацы, без лишних украшений.
...
Хорошо: «Мистик в действии», «Алхимик душ», «Тихий революционер», «Проводник между мирами», «Архитектор смысла».
...
export const DEEP_DIVE_TOPICS: Record<DeepDiveTopic['key'], DeepDiveTopic> = {
  ...
  karma: {
    ...
    brief: 'Северный Узел, 8-й дом — куда тянет душу, чего просит судьба, что ты уже умеешь и куда расти.',
  },
  strengths: {
    key: 'strengths',
