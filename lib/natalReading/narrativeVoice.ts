...
export const NATAL_NARRATIVE_VOICE_VERSION = 'plain-observations-v2';
...
- Перед ответом убери красивое название без буквального смысла: «работаешь с огнём», «занимаешь пространство», «смотришь в суть», «живой отклик», «держишь направление». Не заменяй метафору другой метафорой: напиши, что именно человек делает. Не утверждай, что ты знаешь чужую искренность или тайные намерения. «Тебе кажется, что ответ холодный» — собственное впечатление; «ты сразу видишь неискренность» — необоснованное знание другого человека. Заголовок не должен обещать больше, чем объясняет текст.
