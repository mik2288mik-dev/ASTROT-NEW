...
const CONTENT_MATRIX: Record<LumiaContentType, ContentPolicy> = {
  ...
  sign_compatibility: {
    ...
    cacheTtl: 'forever', cacheScope: 'shared', promptVersion: 'sign_compatibility.v1', purpose: 'Бесплатный разбор связи по двум знакам',
    style: 'Три ясных блока: что тянет, где сложно и как лучше общаться.', placements: ['synastry'], generationPolicy: 'explicit_only',
  },
  blind_spot: {
