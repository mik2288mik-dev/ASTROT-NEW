...
> **Runtime «Дневника»:** все 83 отобранных маскота входят в единый Today-пул из 895 assets вместе с 24 objects и 788 main editorial visuals. Приложение детерминированно выбирает layout и конкретный asset по пользователю, дате и версии контракта; Luna не управляет дизайном, а соседние дни не повторяют asset.
