...
export type SignHoroscopePeriod = 'day' | 'week' | 'month';

export interface SignHoroscopeTextBlock {
  text: string;
  evidenceIds: string[];
}

/**
 * Public contract for the shared zodiac forecast. The prose is generated by
 * the content model, while every cited id points to a deterministic Swiss
...
export interface SignHoroscopeReadingV2 {
  ...
  periodKey: string;
  headline: string;
  mood: SignHoroscopeTextBlock;
  relationships: SignHoroscopeTextBlock;
  work: SignHoroscopeTextBlock;
