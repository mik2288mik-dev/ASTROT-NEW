...
Исходники публичных страниц находятся только в репозитории `mik2288mik-dev/NEBO-WEB`.
Приложение хранит ссылки на них в `lib/storeReleaseConfig.ts`.
...
- Consent-flow проверен для нового пользователя, отказа, повторного входа и
  отзыва.
- Ссылки из итогового APK открывают действующие legal-страницы сайта.
