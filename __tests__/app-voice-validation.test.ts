...
describe('app voice validation', () => {
  ...
  it.each([
    ...
    'При подготовке к поездке проверь билеты.',
    'В назначенное время мастер не пришёл.',
    'Запланированную встречу могут перенести.',
    'В приложении указан пункт пересадки.',
    'Освободившееся время можно провести дома.',
    'После работы может случиться приятная встреча вне дома.',
