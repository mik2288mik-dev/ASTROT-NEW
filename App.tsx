...
const App: React.FC = () => {
    ...
    return (
        <div className="flex flex-col h-full w-full overflow-hidden bg-astro-bg pt-2.5 text-astro-text font-sans selection:bg-astro-highlight selection:text-white">
